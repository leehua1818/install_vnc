...
cat > /etc/apt/sources.list <<EOF
#12.04
deb https://mirrors.aliyun.com/ubuntu/ precise main restricted universe multiverse
...
cat > /etc/apt/sources.list <<EOF
#12.10
deb https://mirrors.aliyun.com/ubuntu/ quantal main restricted universe multiverse
deb https://mirrors.aliyun.com/ubuntu/ quantal-security main restricted universe multiverse
deb https://mirrors.aliyun.com/ubuntu/ quantal-updates main restricted universe multiverse
deb https://mirrors.aliyun.com/ubuntu/ quantal-proposed main restricted universe multiverse
deb https://mirrors.aliyun.com/ubuntu/ quantal-backports main restricted universe multiverse
deb-src https://mirrors.aliyun.com/ubuntu/ quantal main restricted universe multiverse
deb-src https://mirrors.aliyun.com/ubuntu/ quantal-security main restricted universe multiverse
deb-src https://mirrors.aliyun.com/ubuntu/ quantal-updates main restricted universe multiverse
deb-src https://mirrors.aliyun.com/ubuntu/ quantal-proposed main restricted universe multiverse
deb-src https://mirrors.aliyun.com/ubuntu/ quantal-backports main restricted universe multiverse
EOF
apt-get update
}
...
cat > /etc/apt/sources.list <<EOF
#debian6
deb https://mirrors.aliyun.com/debian/ squeeze main non-free contrib
deb https://mirrors.aliyun.com/debian/ squeeze-proposed-updates main non-free contrib
deb-src https://mirrors.aliyun.com/debian/ squeeze main non-free contrib
deb-src https://mirrors.aliyun.com/debian/ squeeze-proposed-updates main non-free contrib
EOF
apt-get update
}
...
cat > /etc/apt/sources.list <<EOF
#debian7
deb https://mirrors.aliyun.com/debian/ wheezy main non-free contrib
deb https://mirrors.aliyun.com/debian/ wheezy-proposed-updates main non-free contrib
deb-src https://mirrors.aliyun.com/debian/ wheezy main non-free contrib
deb-src https://mirrors.aliyun.com/debian/ wheezy-proposed-updates main non-free contrib
EOF
apt-get update
}
...
update_opensuse_source()
{
  ...
  zypper addrepo -f https://mirrors.aliyun.com/opensuse/distribution/13.1/repo/oss/ openSUSE-13.1-Oss-aliyuncs
  zypper addrepo -f https://mirrors.aliyun.com/opensuse/distribution/13.1/repo/non-oss/ openSUSE-13.1-Non-Oss-aliyuncs
  zypper addrepo -f https://mirrors.aliyun.com/opensuse/update/13.1/ openSUSE-13.1-Update-Oss-aliyuncs
  zypper addrepo -f https://mirrors.aliyun.com/opensuse/update/13.1-non-oss/ openSUSE-13.1-Update-Non-Oss-aliyuncs
}
